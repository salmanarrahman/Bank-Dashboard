...
$userData = fileOps::getSingleUser($emailS);
...
$transactionData = fileOps::getTransactionsBySenderEmail(fileOps::getAllTransaction(),$emailS);
                  ...
                  <div
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      foreach ($transactionData as $transaction) {
                          echo "<tr>";
                          echo "<td class='whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-0'>".$transaction['receiverName']."</td>";
                          echo "<td class='whitespace-nowrap py-4 pl-4 pr-3 text-sm text-gray-500 sm:pl-0'>".$transaction['receiverEmail']."</td>";
                          echo "<td class='whitespace-nowrap px-2 py-4 text-sm text-gray-500'>".$transaction['amount']."</td>";
                          echo "</tr>";
                      }
