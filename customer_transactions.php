...
if (isset($_GET['email'])) {
    ...
    $allTransactionData = fileOps::getTransactionsBySenderEmail(fileOps::getAllTransaction(),$email);
    $userName = fileOps::returnName($email,fileOps::getAllUsers());
        ...
        <header class="py-10">
          <div class="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            <h1 class="text-3xl font-bold tracking-tight text-white">
              Transactions of <?php echo $userName?>
            </h1>
          </div>
        </header>
      </div>
              ...
              <div class="sm:flex sm:items-center">
                <div class="sm:flex-auto">
                  <p class="mt-2 text-sm text-gray-700">
                    List of transactions made by <?php echo $userName?>
                  </p>
                </div>
              </div>
                ...
                <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
                  <div
                    ...
                    <table class="min-w-full divide-y divide-gray-300">
                      ...
                      <?php foreach ($allTransactionData as $data){ ?>
                        ...
                        <tr>
                          ...
                          <td
                            ...
                            <?php echo $data["receiverEmail"];?>
                          </td>
                          <td
                            class="whitespace-nowrap px-2 py-4 text-sm font-medium ">
